...
This document provides an overview of the MailSend project for developers and AI agents.

## Project Overview

A client email campaign tool. Users compose branded emails with a clickable banner image (linked to their website) and send them to multiple client addresses. Built with TanStack Start and deployed on Netlify.
